...
import { DrumButton } from '../button/button.component';
...
export const DrumMachineContainer = () => {
  ...
  const [activeBank, setActiveBank] = React.useState(false)

  const [selectedBank, setSelectedBank] = React.useState([])

  const selectBank = (bool) => {
    setSelectedBank(bool === false ? bankOne : bankTwo)
  }

  React.useEffect(() => selectBank(activeBank), [activeBank])

  return (
    <div className='drum-machine-container'>
      <div className='drum-machine-buttons'>
        {
          selectedBank.map((sound, key) => {
            return (
              <DrumButton
                sound={sound}
                key={key}
      ...
      <div className='drum-machine-controls'>
        <CustomToggle name='Power' handleToggle={setPoweredOff} />
